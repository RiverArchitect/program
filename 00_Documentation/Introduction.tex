...
\begin{tabular}{l p{0.13\textwidth} L{0.295\textwidth} l l p{0.14\textwidth} L{0.26\textwidth}}
		...
		\multicolumn{3}{l}{\textbf{Flow velocity (in fps or m/s):}} & &\multicolumn{3}{l}{\textbf{Flow depth (in ft or m):}}\\ 
